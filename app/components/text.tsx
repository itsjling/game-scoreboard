...
const $fontWeightStyles: Record<Weights, TextStyle> = {} as Record<
  Weights,
  TextStyle
>;
for (const [weight, fontFamily] of Object.entries(typography.primary)) {
  $fontWeightStyles[weight as Weights] = { fontFamily };
}
