...
import type { colors as colorsLight } from "./colors";
import type { colors as colorsDark } from "./colors-dark";
import type { spacing as spacingLight } from "./spacing";
import type { spacing as spacingDark } from "./spacing-dark";
