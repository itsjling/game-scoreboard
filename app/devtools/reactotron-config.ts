...
reactotron.use(mmkvPlugin<ReactotronReactNative>({ storage: storage.storage }));

const IGNORE_SYMBOLICATE_URLS = /symbolicate/;

// biome-ignore lint/correctness/useHookAtTopLevel: false positive - useReactNative is a plugin, not a React hook
reactotron.useReactNative({
  networking: {
    ignoreUrls: IGNORE_SYMBOLICATE_URLS,
  },
});
